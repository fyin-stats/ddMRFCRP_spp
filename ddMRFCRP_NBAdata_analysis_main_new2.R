...
data_filenames <- c("pp_region_Lillard.rds", "pp_region_griffin.rds")
...
time2 <- Sys.time()
##########################
saveRDS(results_summary_list, "NBAdata_results_summary_list_new2.rds")
saveRDS(results_list, "NBAdata_results_list_new2.rds")