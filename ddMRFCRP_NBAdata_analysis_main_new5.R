...
data_filenames <- c("pp_region_Butler.rds", "pp_region_thompson.rds")
...
time2 <- Sys.time()
##########################
saveRDS(results_summary_list, "NBAdata_results_summary_list_new5.rds")
saveRDS(results_list, "NBAdata_results_list_new5.rds")