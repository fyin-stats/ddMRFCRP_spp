...
data_filenames <- c("pp_region_Antetokounmpo.rds",
...
time2 <- Sys.time()
##########################
saveRDS(results_summary_list, "NBAdata_results_summary_list_new.rds")
saveRDS(results_list, "NBAdata_results_list_new.rds")