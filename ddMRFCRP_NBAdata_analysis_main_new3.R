...
data_filenames <- c("pp_region_towns.rds", "pp_region_westbrook.rds", "pp_region_howard.rds", 
                    "pp_region_paul.rds", "pp_region_Aldridge.rds")
...
time2 <- Sys.time()
##########################
saveRDS(results_summary_list, "NBAdata_results_summary_list_new3.rds")
saveRDS(results_list, "NBAdata_results_list_new3.rds")